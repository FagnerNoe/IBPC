...
titulo = Container(
   ...
   content=Text("Eventos da Igreja",          
                size=34,
                color="White",
   ...
   content=Column(
               ...
               ElevatedButton(
                  ...
                  content=Row(
                     ...
                     Text("LOCALIZAR EVENTO",color="white",size=18)
                  ]),
                  style=ButtonStyle(
               ...
               DataTable(
                         ...
                         border=Border(
                            ...
                            columns=[DataColumn(label=Text("DATA",color="black"),
                                                numeric=True),
                                     DataColumn(label=Text("EVENTO",color="black"))
                            ],
                            rows=[                                  
...
def agenda(page:Page,params:Params,basket:Basket):
