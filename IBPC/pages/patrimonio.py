...
titulo = Container(
   ...
   content=Text("Cadastro de Patrimônios",          
                size=34,
                color="White",
   ...
   content=Column(
               ...
               ElevatedButton(
                  ...
                  content=Row(
                     ...
                     Text("LOCALIZAR PATRIMÔNIO",color="white",size=18)
                  ]),
                  style=ButtonStyle(
               ...
               DataTable(
                         ...
                         border=Border(
                            ...
                            columns=[DataColumn(label=Text("CÓDIGO",color="black"),
                                                numeric=True),
                                     DataColumn(label=Text("PATRIMÔNIO",color="black"))
                            ],
                            rows=[                                  
...
def patrimonio(page:Page,params:Params,basket:Basket):
